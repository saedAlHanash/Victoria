...
class _OrderTrackingScreenState extends State<OrderTrackingScreen> {
  ...
  void initState() {
    ...
    Provider.of<OrderProvider>(context, listen: false).timerApiCall(widget.orderID, context);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: ResponsiveHelper.isDesktop(context)? PreferredSize(child: WebAppBar(), preferredSize: Size.fromHeight(120)) : CustomAppBar(title: getTranslated('order_tracking', context)),
