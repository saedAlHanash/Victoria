...
class ProductDetailsScreen extends StatelessWidget {
  ...
  _loading(BuildContext context) async {
    ...
    await Provider.of<ProductProvider>(context, listen: false).getProductReviews(
        context, product.id);
      ...
      builder: (context, productProvider, child) {
        ...
        if (productProvider.product != null &&
          ...
          _tabChildren = [
            ...
            (productProvider.product.description == null ||
                productProvider.product.description.isEmpty) ? Center(child: Text(
                getTranslated('no_description_found', context), style: TextStyle(
                  ...
                  Row(
                    children: [
                      Expanded(flex: 4, child: Column(
                        ...
                        children: [
                          Text('${ productProvider.product.rating.length > 0 ? double
                              .parse(productProvider.product.rating.first.average)
                              .toStringAsFixed(1) : 0.0}', style: TextStyle(fontSize: 70,
                              fontWeight: FontWeight.w700,
                              color: Colors.deepOrange)),
                          SizedBox(height: Dimensions.PADDING_SIZE_DEFAULT),
                          RatingBar(
                              rating: productProvider.product.rating.length > 0 ? double
                                  .parse(productProvider.product.rating[0].average) : 0.0,
                              size: 30,
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(productProvider.productReviewList.length.toString() +
                                  ' Reviews', style: rubikRegular.copyWith(
                    ...
                    SizedBox(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Text('${productProvider.product.rating.length > 0 ? double.parse(
                            productProvider.product.rating.first.average).toStringAsFixed(
                            1) : 0.0}', style: TextStyle(fontSize: 40,
                            fontWeight: FontWeight.w700,
                            color: Colors.deepOrange)),
                        SizedBox(height: Dimensions.PADDING_SIZE_DEFAULT),
                        RatingBar(
          ...
          for (int index = 0; index <
            ...
            _variationList.add(
                productProvider.product.choiceOptions[index].options[productProvider
                    .variationIndex[index]].replaceAll(' ', ''));
          }
          ...
          isExistInCart =
              Provider.of<CartProvider>(context).isExistInCart(_cartModel, false, null);
          if (isExistInCart) {
        ...
        return Scaffold(
          ...
          appBar: ResponsiveHelper.isDesktop(context) ? PreferredSize(
              child: WebAppBar(), preferredSize: Size.fromHeight(120)) : DetailsAppBar(
              key: _key),
                                  ...
                                  SizedBox(
                                    ...
                                    child: FadeInImage.assetNetwork(
                                      ...
                                      image: '${Provider
                                          ...
                                          .baseUrls
                                          .productImageUrl}/${productProvider.product
                                          .image[Provider
                                          .of<CartProvider>(context, listen: false)
                                          .productSelect]}',
                                      imageErrorBuilder: (c, o, s) => Image.asset(
                                          Images.placeholder(context), fit: BoxFit.cover),
                                    ),
                                  ),
                                  SizedBox(height: 10),
                                            ...
                                            child: InkWell(
                                              onTap: () {
                                                Provider.of<CartProvider>(
                                                    context, listen: false).setSelect(
                                                    index, true);
                                              },
                                              child: Container(
                                                width: 100,
                                        ...
                                        Row(children: [
                                          QuantityButton(isIncrement: false,
                                              quantity: isExistInCart
                                                  ? _cartProvider.cartList[_cartProvider
                                                  .getCartProductIndex(
                                                  _cartModel, false, null)].quantity
                                          ...
                                          Text(isExistInCart ? _cartProvider
                                              ...
                                              _cartModel, false, null)].quantity
                                              .toString() : productProvider.quantity
                                              .toString(), style: rubikBold.copyWith(
                                              fontSize: Dimensions
                                          ...
                                          child: Row(
                                            children: [
                                              Expanded(
                                                ...
                                                child: Container(
                                                  child: CustomButton(
                                                    btnTxt: getTranslated(isExistInCart
                    ...
                    child: Row(children: [
                      Expanded(child: InkWell(
                        ...
                        child: Column(children: [
                          Center(child: Text(getTranslated('description', context),
                              style: productProvider.tabIndex == 0 ? rubikBold.copyWith(
                                  fontSize: Dimensions.FONT_SIZE_OVER_LARGE, color: Theme
                                  .of(context)
                                  .primaryColor
                                  .withOpacity(1))
                          ...
                          Divider(thickness: 3,
                              color: Theme
                                  .of(context)
                                  .primaryColor
                                  .withOpacity(productProvider.tabIndex == 0 ? 1 : 0.0),
                              endIndent: 20,
                              indent: 20),
                        ]),
                      )),
                      Expanded(child: InkWell(
                        ...
                        child: Column(children: [
                          Center(child: Text(getTranslated('review', context),
                              style: productProvider.tabIndex == 1 ? rubikBold.copyWith(
                                  fontSize: Dimensions.FONT_SIZE_OVER_LARGE, color: Theme
                                  .of(context)
                                  .primaryColor
                                  .withOpacity(1))
                          ...
                          Divider(thickness: 3,
                              color: Theme
                                  .of(context)
                                  .primaryColor
                                  .withOpacity(productProvider.tabIndex == 1 ? 1 : 0.0),
                              endIndent: 20,
                              indent: 20),
                        ]),
                      )),
                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text(productProvider.product.choiceOptions[index]
                                          .title, style: rubikMedium.copyWith(
                                          fontSize: Dimensions.FONT_SIZE_LARGE)),
                                      SizedBox(
                            ...
                            productProvider.product.choiceOptions.length > 0 ? SizedBox(
                                height: Dimensions.PADDING_SIZE_LARGE) : SizedBox(),
                            ...
                            Row(children: [
                              ...
                              Container(
                                ...
                                child: Row(children: [
                                    ...
                                    onTap: () {
                                      if (isExistInCart) {
                                        if (_cartProvider.cartList[_cartProvider
                                            .getCartProductIndex(_cartModel, false, null)]
                                            .quantity > 1) {
                                          _cartProvider.setQuantity(
                                              false, _cartModel, _cartModel.maxQty,
                                              context, true,
                                  ...
                                  Text(
                                      isExistInCart ? _cartProvider.cartList[_cartProvider
                                          .getCartProductIndex(_cartModel, false, null)]
                                          .quantity.toString()
                                  ...
                                  InkWell(
                                    onTap: () =>
                                    isExistInCart ? _cartProvider.setQuantity(
                                        true, _cartModel, 50, context, true,
                                        _cartProvider.getCartProductIndex(
                                            _cartModel, false, null)) : productProvider
                                        .setQuantity(true, _stock, context),
                                    child: Padding(
                                      padding: EdgeInsets.symmetric(
                                          horizontal: Dimensions.PADDING_SIZE_SMALL,
                                          vertical: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                              ...
                              Expanded(child: InkWell(
                                ...
                                child: Column(children: [
                                  ...
                                  Divider(thickness: 3, color: Theme
                                      ...
                                      .primaryColor
                                      .withOpacity(
                                      productProvider.tabIndex == 1 ? 1 : 0.2)),
                                ]),
                              )),
                            ]),
  ...
  Widget build(BuildContext context) {
    return InkWell(
        ...
        if (isExistInCart) {
          if (!isIncrement && quantity > 1) {
            Provider.of<CartProvider>(context, listen: false).setQuantity(
                ...
                Provider.of<CartProvider>(context, listen: false).getCartProductIndex(
                    cart, false, null));
          } else if (isIncrement) {
            if (quantity < stock) {
              Provider.of<CartProvider>(context, listen: false).setQuantity(
      ...
      child: Container(
        ...
        height: 50, width: 50,
        decoration: BoxDecoration(borderRadius: BorderRadius.circular(5), color: Theme
            .of(context)
            .primaryColor),
        child: Center(
          child: Icon(
