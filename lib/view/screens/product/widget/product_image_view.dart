...
class ProductImageView extends StatelessWidget {
            ...
            InkWell(
              ...
              child: Stack(children: [
                ...
                Positioned(
                  ...
                  bottom: 0,
                  child: Padding(
                    padding: EdgeInsets.only(bottom: Dimensions.PADDING_SIZE_SMALL / 1.5),
                    child: Row(
  ...
  List<Widget> _indicators(BuildContext context) {
    ...
    for (int index = 0; index < productModel.image.length; index++) {
      indicators.add(
        //TODO: تغيير لون ال indecator
        TabPageSelectorIndicator(
          backgroundColor: index == Provider.of<ProductProvider>(context).imageSliderIndex
              ? Colors.white
              : Color(0xFFf3c735),
          borderColor: Color(0xFFf3c735),
          size: 7,
        ),
      );
    }
