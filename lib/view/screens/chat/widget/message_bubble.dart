                                ...
                                if (messages.message != null)
                                  Flexible(
                                    child: Container(
                                      ...
                                      child: Container(
                                        child: Padding(
                                          padding: EdgeInsets.all(messages.message != null
                                ...
                                messages.attachment != null
                                    ? GridView.builder(
                                        gridDelegate:
                                          ...
                                          childAspectRatio: 1,
                                          crossAxisCount:
                                              ResponsiveHelper.isDesktop(context) ? 8 : 3,
                                          crossAxisSpacing: 5,
                                          mainAxisSpacing: 5,
                                        ),
                                        shrinkWrap: true,
                                  ...
                                  if (messages.message != null)
                                    Flexible(
                                      child: Container(
                                        decoration: BoxDecoration(
                                          color:
                                              ColorResources.getChatAdminColor(context),
                                          borderRadius: BorderRadius.only(
                                  ...
                                  messages.attachment != null
                                      ? Directionality(
                                          ...
                                          child: GridView.builder(
                                            ...
                                            itemCount: messages.attachment.length,
                                            itemBuilder: (BuildContext context, index) {
                                              return (messages.attachment.length !=
                                                          null &&
                                    ...
                                    children: [
                                      (messages.message != null &&
                                          ...
                                          ? Flexible(
                                              child: Container(
                                                decoration: BoxDecoration(
                                                  color: ColorResources.getChatAdminColor(
                                                      context),
                                                  borderRadius: BorderRadius.only(
                                                    topLeft: Radius.circular(10),
                                                    bottomRight: Radius.circular(10),
