...
class CartScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool _isSelfPickupActive =
        Provider.of<SplashProvider>(context, listen: false).configModel.selfPickup == 1;
    ...
    return Scaffold(
      appBar: ResponsiveHelper.isDesktop(context)
          ...
          : CustomAppBar(
              title: getTranslated('my_cart', context), isBackButtonExist: fromDetails),
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        if (!ResponsiveHelper.isDesktop(context))
                                          productView(
                                              cart, _total, _couponController, context),
                                        // Product
      ...
      child: CustomButton(
          ...
          onTap: () {
            if (_itemPrice <
              ...
              Navigator.pushNamed(
                  context,
                  Routes.getCheckoutRoute(_total, 'cart',
    ...
    return Column(
      children: [
        ...
        _isSelfPickupActive
            ...
            //TODO: اضافة خيارات زين كاش والماستر
            ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                DeliveryOptionButton(
                  value: 'baghdad',
                  title: getTranslated('baghdad', context),
                  kmWiseFee: _kmWiseCharge,
                ),

                DeliveryOptionButton(
                  value: 'other_state',
                  title: getTranslated('other_state', context),
                  kmWiseFee: _kmWiseCharge,
                ),
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Text(getTranslated(_kmWiseCharge ? 'subtotal' : 'total_amount', context),
  ...
  Container cupponView(
      BuildContext context, TextEditingController _couponController, double _total) {
    return Container(
      decoration: BoxDecoration(
          color: Theme.of(context).cardColor,
            ...
            Expanded(
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle:
                      rubikRegular.copyWith(color: ColorResources.getHintColor(context)),
                  isDense: true,
                  filled: true,
