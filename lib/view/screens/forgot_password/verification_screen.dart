...
class VerificationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: Provider.of<SplashProvider>(context, listen: false).configModel.emailVerification
          ? ResponsiveHelper.isDesktop(context)? PreferredSize(child: WebAppBar(), preferredSize: Size.fromHeight(120))
          : CustomAppBar(title: getTranslated('verify_email', context)) :
      ResponsiveHelper.isDesktop(context)? PreferredSize(child: WebAppBar(), preferredSize: Size.fromHeight(120)) :
      CustomAppBar(title: getTranslated('verify_phone', context)),
