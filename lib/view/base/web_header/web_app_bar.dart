...
class _WebAppBarState extends State<WebAppBar> {
  ...
  Widget build(BuildContext context) {
    ...
    LanguageModel _currentLanguage = AppConstants.languages.firstWhere((language) =>
    ...
    return Container(
      ...
      child: Column(
        children: [
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Icon(Icons.lock,
                                        size: 16, color: Theme.of(context).cardColor),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                    child: Text(getTranslated('log_out', context),
                                        style: rubikRegular.copyWith(
          ...
          Expanded(
            child: Container(
              color: ColorResources.getHeaderColor(context),
              child: Center(
                child: SizedBox(
                    width: Dimensions.WEB_SCREEN_WIDTH,
                    child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              child:
                                ...
                                return CustomTextField(
                                  ...
                                  suffixIconUrl: search.searchController.text.length > 0
                                      ? Images.close
                                      : Images.search,
                                  onChanged: (str) {
                                    str.length = 0;
                                  ...
                                  onSuffixTap: () {
                                    if (search.searchController.text.length > 0 &&
                                      ...
                                      search.searchDone();
                                    } else if (search.searchController.text.length > 0 &&
                            ...
                            IconButton(
                                ...
                                icon: Icon(Icons.menu,
                                    ...
                                    color:
                                        ColorResources.getBlackAndWhiteColor(context))),
                            SizedBox(width: Dimensions.PADDING_SIZE_SMALL)
                          ],
                        )
                      ],
