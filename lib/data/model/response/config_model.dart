class ConfigModel {
  ...
  num deliveryChargeBaghdad;
  num deliveryChargeOther;
  ...
  ConfigModel({
    ...
    this.deliveryChargeBaghdad = deliveryChargeBaghdad;
    this.deliveryChargeOther = deliveryChargeOther;
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    deliveryChargeBaghdad = json['delivery_charge_baghdad'];
    deliveryChargeOther = json['delivery_charge_other'];
